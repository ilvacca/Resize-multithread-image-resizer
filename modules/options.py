...
class option_panel:
    ...
    def __init__(self,parent,output_extension,current_options):
        ...
        self.algorithm_frame = algorithm_option_frame(self.opt_panel,self.current_options['resampling'])
...
class output_single_card:
    ...
    def __init__(self,parent,row,column,label,descr,list_items):
        ...
        #self.combobox_style.configure("TCombobox",foreground='maroon')
        self.combobox = ttk.Combobox(self.frame,values=list_items,height=5,width=8,style="TCombobox")
...
class algorithm_option_frame:
    ...
    def __init__(self,parent,selected_algorithm):
        ...
        if selected_algorithm == "NEAREST":
            self.selected_algorithm_v2 = Tkinter.IntVar(value=0)
        elif selected_algorithm == "ASDASDASDASDASDASDAS":
        ...
        self.nneigh = Tkinter.Radiobutton(self.frame, width=self.button_width,
                                          ...
                                          text="Nearest\nNeighbor", bd=0, bg="#125A71",selectcolor=self.button_selected_background,activebackground=self.button_active_background,anchor="sw", indicatoron=0, fg=self.button_fg,
        ...
        self.blin = Tkinter.Radiobutton(self.frame, width=self.button_width, height=self.button_height,
                                        font=self.button_font, value=1, variable=self.selected_algorithm_v2 , text="Bilinear\nInterpolation",
        ...
        self.bicu = Tkinter.Radiobutton(self.frame, width=self.button_width, height=self.button_height,
                                        font=self.button_font, value=2, variable=self.selected_algorithm_v2 , text="Bicubic\nInterpolation", bd=0,
